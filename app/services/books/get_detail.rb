module Books
  class GetDetail < ApplicationService
    ...
    def call
      ...
      return Book.new(title: book_data[:title], author: book_data[:authors][0][:name], pages: book_data[:number_of_pages].to_i, book_cover: book_data[:cover][:medium], isbn: @indentifier)
      # [:cover][:medium]
